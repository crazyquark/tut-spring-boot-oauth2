 ...
 *
 * Represents an OpenID Token retrieved from Azure. Adds some additional
 * information that azure requires, and some that security requires.
 */
public class AzureAccessToken extends DefaultOAuth2AccessToken {

  private static final long serialVersionUID = 6552829445321704190L;
  ...
  private void parseAzureTokenInformation(DefaultOAuth2AccessToken accessToken) throws IOException {
    ...
    if (info != null && info.size() > 0) {
      ...
      if (profile64Encoded != null) {
        // AlexB: this doesn' seem to be supported by Azure AD Anymore
        ...
        try {
          ...
          this.profile = null;
          // There are times when Azure returns some malformed JSON for the
          // profile_info.
        }
      }
    }
